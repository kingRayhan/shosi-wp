...
function wp_shosi_scripts() {
	 ...
	 * Stylesheets
	 */
	$color_scheme = get_theme_mod( 'shosi_color_scheme', 'primary' );
	...
	wp_enqueue_style( 'shosi', get_template_directory_uri() . '/assets/css/color-schemes/style-'.$color_scheme.'.css', array() , '1.0.0' , 'all' );
